...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ResourceInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).resource.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ResourceInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).resource.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ResourceInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).resource.findFirst(input as any))),

        findMany: procedure.input($Schema.ResourceInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).resource.findMany(input as any))),
        ...
        count: procedure.input($Schema.ResourceInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).resource.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.ResourceCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.ResourceCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.ResourceCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.ResourceCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.ResourceCountArgs>, 'cursor'>,
